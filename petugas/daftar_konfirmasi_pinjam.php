...
<?php
    echo "
    <td align=center><button><a href=finputbalik.php?nomor=$baris[no_transaksi] onclick='return confirm(\"Anda yakin data barang $baris[no_transaksi] akan diinputkan pengembalian?\")'>Kembali</a></button></td></tr></tbody>";
    $no++;
    }
    echo "</table>";
    ?>
