...
<fieldset>
<input placeholder="Tanggal Entry" type="date" name="tgl_entry" required value= <?php echo "$data[5]" ?>>
</fieldset>
<fieldset>
<label>
<input placeholder="Gambar" type="file" name="gambar" value= <?php echo "$data[4]" ?>> 
</label></fieldset>
<fieldset>
